...
const NicheSolution = () => {
    const list2 = [
        {
            data: "Transportation management system"
        },
        {
            data: "Fleet management system"
        },
        {
            data: "Enterprise resource planning (ERP) software"
        },
        {
            data: "Warehouse management system"
        },
        {
            data: "Manufacturing execution systems"
        },
        {
            data: "Yard management systems"
        }
    ]
    return (
        <section className="bg-secondary font-poppins flex justify-center py-20 items-start sm:px-16 px-6">
            <div className="xl:max-w-[1280px] justify-between w-full flex flex-col">
                <div className="text-4xl font-medium mb-10 text-white leading-normal">
                    <h1>
                        Niche <span className="text-primary">based solutions</span> we build
                    </h1>
                </div>
                <div className="text-primary mb-11">
                    Enabling business optimize their business process and improve decision making power
                </div>
                <div>
                    <ul className="grid sm:grid-cols-2 grid-cols-1 md:grid-cols-3">
